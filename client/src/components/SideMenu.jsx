...
const navItems = [
  ...
  { label: "Statistics", to: "/statistics", icon: AssessmentIcon },
  { label: "Purchases", to: "/purchase-details", icon: ReceiptIcon },
  { label: "Sales", to: "/sales", icon: AttachMoneyIcon },
  { label: "Manage Stores", to: "/manage-store", icon: StoreIcon },
  { label: "Stores Map", to: "/stores-map", icon: MapIcon },
];
...
function SideMenu({ collapsed = false, onToggleCollapse }) {
  return (
