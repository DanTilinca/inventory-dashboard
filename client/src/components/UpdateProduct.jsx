...
export default function UpdateProduct({ updateProductData, updateModalSetting, handlePageUpdate }) {
  const { _id, name, category, description } = updateProductData;
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1 text-left">
                      ...
                      <p className="mt-0.5 text-sm text-base-content/60">
                        Edit name, category, and description for this product.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="px-5 py-4">
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="sm:col-span-1">
                      <label htmlFor="update-name" className="mb-1.5 block text-xs font-semibold uppercase tracking-wide text-base-content/50">
                        Name
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="sm:col-span-1">
                      <label htmlFor="update-category" className="mb-1.5 block text-xs font-semibold uppercase tracking-wide text-base-content/50">
                        Category
                      </label>
                      <select
                        id="update-category"
                    ...
                    <div className="sm:col-span-2">
                      <label htmlFor="update-description" className="mb-1.5 block text-xs font-semibold uppercase tracking-wide text-base-content/50">
                        Description
                      </label>
                      <textarea
